...
<body>
    ...
    <div class="container-fluid" >
        ...
        <?php
            ...
            <img src="<?php echo $row['image'] ?>" alt="image " class="img-fluid card-img-top  img-responsive" style="height:250px">
        ...
        <div class="card-body">
            ...
            <input type="text" name="quantity" class="form-control" value="1">
                                ...
                                <input type="submit" class="btn btn-warning my-3" value="Add to Cart" name="add"> <i class="fas fa-shopping-cart"></i>
                            </div>
        </div>
    </div>
